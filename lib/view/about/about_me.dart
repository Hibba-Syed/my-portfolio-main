          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'I am a Flutter Developer with over 2.5 years of professional experience building production-grade, scalable mobile applications. I have delivered end-to-end mobile solutions—from initial concept and architecture to deployment and post-release optimization—while collaborating closely with cross-functional teams to create reliable, high-performing digital products.\n\nMy expertise includes advanced state management (Bloc, Cubit, Provider), clean and scalable architectures (MVC, MVVM), robust RESTful API integrations, and performance optimization. I consistently write clean, testable, and maintainable code, with a strong focus on scalability, performance, and long-term product success. I thrive on solving complex technical challenges and crafting mobile experiences that drive real user and business value.',
                  style: TextStyle(
                    fontSize: 15,
                    height: 1.7,
                    color: Colors.white60,
                ...
                Wrap(
                  ...
                  children: const [
                   ...
                   // _SkillChip('App Store & Play Store Deployment'),
                    _SkillChip('Play Store Deployment'),
               ...
               const _BulletPoint('Integrated complex RESTful APIs and third-party SDKs to create seamless app experiences.'),
               ...
               const _BulletPoint('Optimized app performance, memory usage for smooth user experiences.'),
               const _BulletPoint('Conducted code reviews and enforced best practices across projects.'),
